...
class Experiment:
    ...
    def _setup_dataset(self):
        self._train_dataset = MOFDataset(
            ...
            is_training=True,
            use_block_emb=True,
            split_idx=os.path.join(self._data_cfg.cache_dir, 'train_bb.idx'),
        )
        self._valid_dataset = MOFDataset(
            ...
            is_training=False,
            use_block_emb=True,
            split_idx=os.path.join(self._data_cfg.cache_dir, 'val_bb.idx'),
        )
...
@hydra.main(version_base=None, config_path=str(PROJECT_ROOT / "configs"), config_name="bfn_base_bhm_tot.yaml")
