...
class EvalRunner:
    ...
    def __init__(self, cfg: DictConfig):
        ...
        self._flow_module = CrysBFN_CSP_PL_Model.load_from_checkpoint(
...
@hydra.main(version_base=None, config_path=str(PROJECT_ROOT / "configs"), config_name="bfn_infer_bhm")
