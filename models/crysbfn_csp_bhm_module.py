...
from models.crysbfn_csp_bhm import CrysBFN_CSP
MAX_ATOMIC_NUM=100
...
class CrysBFN_CSP_PL_Model(BaseModule):
    def __init__(self, cfg, device) -> None:
        ...
        self.BFN:CrysBFN_CSP = hydra.utils.instantiate(self.cfg.BFN, hparams=self.cfg, device=device,
                                           _recursive_=False)
    ...
    def forward(self, batch):
        ...
        lattice_loss, coord_loss, rot_loss = self.BFN.loss_one_step(
            t = None,
